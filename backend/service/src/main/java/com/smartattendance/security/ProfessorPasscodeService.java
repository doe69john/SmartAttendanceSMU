...
@Service
public class ProfessorPasscodeService {

    private final PasswordEncoder passwordEncoder;
    private final String passcodeHash;

    @Autowired
    public ProfessorPasscodeService(PasswordEncoder passwordEncoder,
                                    @Value("${app.security.professor-passcode-hash:}") String passcodeHash,
                                    @Value("${app.security.professor-passcode:}") String passcodePlaintext) {
        this(passwordEncoder, passcodeHash, passcodePlaintext, true);
    }

    ProfessorPasscodeService(PasswordEncoder passwordEncoder,
                             String passcodeHash,
